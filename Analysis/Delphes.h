...
// Tue Aug 26 16:42:29 2025 by ROOT version 6.30/09
// from TTree Delphes/Analysis tree
// found on file: Sn1_hzLFV.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 83;
   static constexpr Int_t kMaxGenVertex = 7;
   static constexpr Int_t kMaxTrack = 15;
   static constexpr Int_t kMaxTower = 19;
   static constexpr Int_t kMaxEFlowTrack = 15;
   static constexpr Int_t kMaxEFlowPhoton = 12;
   static constexpr Int_t kMaxEFlowNeutralHadron = 4;
   static constexpr Int_t kMaxParticleFlowCandidate = 23;
   static constexpr Int_t kMaxCaloPhoton = 12;
   static constexpr Int_t kMaxPhotonEff = 8;
   static constexpr Int_t kMaxPhotonIso = 8;
   static constexpr Int_t kMaxGenJet = 4;
   static constexpr Int_t kMaxGenMissingET = 1;
   static constexpr Int_t kMaxJet = 4;
   static constexpr Int_t kMaxElectron = 5;
   static constexpr Int_t kMaxPhoton = 8;
   static constexpr Int_t kMaxMuon = 5;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Sn1_hzLFV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Sn1_hzLFV.root");
      }
