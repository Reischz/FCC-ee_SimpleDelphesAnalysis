...
void plot_allFinalProcessInfo(const char* Png_prefix="", const char* filename = "output01.root")
{
	...
	legend->AddEntry(Jet_PT_hist, Form("Jet (%d)", (int)Jet_PT_hist->GetEntries()), "f");
	legend->AddEntry(Electron_Pt_hist, Form("Electron (%d)", (int)Electron_Pt_hist->GetEntries()), "f");
	legend->AddEntry(Muon_Pt_hist, Form("Muon (%d)", (int)Muon_Pt_hist->GetEntries()), "f");
	legend->Draw();
	...
	legend->Clear();
	legend->AddEntry(Jet_size_hist, Form("Jet (%d)", (int)Jet_size_hist->GetEntries()), "f");
	legend->AddEntry(Electron_size_hist, Form("Electron (%d)", (int)Electron_size_hist->GetEntries()), "f");
	legend->AddEntry(Muon_size_hist, Form("Muon (%d)", (int)Muon_size_hist->GetEntries()), "f");
	legend->Draw();
	...
	legend->Clear();
	legend->AddEntry(Jet_Eta_hist, Form("Jet (%d)", (int)Jet_Eta_hist->GetEntries()), "f");
	legend->AddEntry(Electron_Eta_hist, Form("Electron (%d)", (int)Electron_Eta_hist->GetEntries()), "f");
	legend->AddEntry(Muon_Eta_hist, Form("Muon (%d)", (int)Muon_Eta_hist->GetEntries()), "f");
	legend->Draw();
	...
	legend->Clear();
	legend->AddEntry(Jet_Phi_hist, Form("Jet (%d)", (int)Jet_Phi_hist->GetEntries()), "f");
	legend->AddEntry(Electron_Phi_hist, Form("Electron (%d)", (int)Electron_Phi_hist->GetEntries()), "f");
	legend->AddEntry(Muon_Phi_hist, Form("Muon (%d)", (int)Muon_Phi_hist->GetEntries()), "f");
	legend->Draw();
	...
	legend->Clear();
	legend->AddEntry(Electron_Charge_hist, Form("Electron (%d)", (int)Electron_Charge_hist->GetEntries()), "f");
	legend->AddEntry(Muon_Charge_hist, Form("Muon (%d)", (int)Muon_Charge_hist->GetEntries()), "f");
	legend->Draw();
